...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    # vp diagnostic
    ret.cruiseState.speed = cp.vl["PSCM1"]['SteeringAngleServo'] * CV.KPH_TO_MS * 10 + 100
    ...
    # SNG
    self.standstill = bool(cp_cam.vl["FSM3"]['ACC_Standstill'])
    self.accdistance = int(cp_cam.vl["FSM1"]['ACC_Distance'])
